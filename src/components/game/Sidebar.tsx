      ...
      tree.push({
        ...
        days: days.map((day) => ({
          ...
          memories: memories.filter(
            (m) => (m.chapter || '未知章节') === chapter && (m.day ?? 1) === day
          )
        }))
      })
    }
    ...
    <>
      ...
      <div
        ...
        <Tabs defaultValue="relations" className="flex-1 flex flex-col">
          ...
          <TabsContent
            value="relations"
            className="flex-1 px-3 mt-2 overflow-hidden">
              ...
              {chapterTree.length === 0 ? (
                ...
                <div className="space-y-1">
                  {chapterTree.map((ch) => {
                    ...
                    const chapterActive = ch.days.some((d) =>
                      isSelectedDay(d.day)
                    )
                    return (
                      <div
